...
function logout() {
  ...
  document.getElementsByClassName("header_nav_confirm_off").style.display = "none";
  document.getElementsByClassName("header_nav_confirm_on").style.display = "block";
}
