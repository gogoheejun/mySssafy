...
public class PostServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//1.한글처리(UTF-8, EUC-KR등)
	      ...
	      response.getWriter().append("암호: "+score+"<br>");
	      response.getWriter().append("결과: "+result+"<br>");

//	      response.getWriter().append("<a href='exam/postTest.html'>처음으로</a>"); //상대경로
	      response.getWriter().append("<a href='/edu/exam/postTest.html'>처음으로</a>");//절대경로
