...
//		DB Logic
		...
		ResultSet rs = null;
		try {
			conn = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3307/ssafyweb?serverTimezone=UTC&useUniCode=yes&characterEncoding=UTF-8", "ssafy", "369369");
...
//		out.print("당신은 ");
		for(int i=0;i<zeroLen;i++)
			out.print("<img src=\"/basic_web/img/img_0.png\" width=\"80\">");
		for(int i=0;i<cntLen;i++)
			out.print("<img src=\"/basic_web/img/img_" + cntStr.charAt(i) + ".png\" width=\"80\">");
